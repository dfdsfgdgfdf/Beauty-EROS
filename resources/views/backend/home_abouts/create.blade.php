    ...
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex">
                <div class="col-6">
                    <h6 class="m-0 font-weight-bold text-primary">انشاء الصفحة الرئيسية (عن المركز)</h6>
                </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.home_abouts.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-9">
