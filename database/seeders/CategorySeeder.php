...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        $clothes = Category::create(['name' => 'Building', 'cover' => 'images/category/clothes.jpg', 'status' => true, 'parent_id' => null, 'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.']);
        ...
        $shoes = Category::create(['name' => 'Cars', 'cover' => 'images/category/shoes.jpg', 'status' => true, 'parent_id' => null, 'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.']);
        ...
        $watches = Category::create(['name' => 'Medical', 'cover' => 'images/category/watches.jpg', 'status' => true, 'parent_id' => null, 'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.']);
        ...
        $electronics = Category::create(['name' => 'Jobs', 'cover' => 'images/category/electronics.jpg', 'status' => true, 'parent_id' => null, 'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.']);
