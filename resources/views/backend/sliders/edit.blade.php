    ...
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex">
                <div class="col-6">
                    <h6 class="m-0 font-weight-bold text-primary">تعديل الصفحة الرئيسية (الصور المنزلقة)</h6>
                </div>
                ...
                <form action="{{ route('admin.sliders.update', $slider->id) }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" {{ old('status', $slider->status) == 1 ? 'selected' : null }}>نشط</option>
                                <option value="0" {{ old('status', $slider->status) == 0 ? 'selected' : null }}>غير نشط</option>
                            </select>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            <textarea name="text" rows="5" class="form-control">{!! old('text', $slider->text) !!}</textarea>
                    ...
                    <div class="row mt-5">
                        <div class="col-12 form-group mt-5">
                            ...
                            <input type="text" name="video" value="{{ old('video', $slider->video) }}" class="form-control" placeholder="هذا الحقل اختياري - اذا كان هناك لينك فيديو برجاء اختياره من اليوتيوب">
            ...
            $('#category_image').fileinput({
                ...
                initialPreviewConfig: [
                    @if ($slider->image != '')
                    {
                         ...
                         size: '1000',
                         width: "120px",
                         url: "{{ route('admin.sliders.removeImage', ['slider_id'=>$slider->id, '_token' => csrf_token()]) }}",
                         key: "{{ $slider->id }}"
                    },
                    @endif
                ],
